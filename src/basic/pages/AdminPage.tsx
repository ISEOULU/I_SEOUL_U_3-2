...
import { ActionResult, AddNotification, CouponActions, CouponFormType, ProductActions, ProductWithUI } from "../../types";
...
function AdminPage({ products, updateProduct, addProduct, setProducts, coupons, addCoupon, deleteCoupon, addNotification, notify, formatPrice }: AdminPageProps) {
